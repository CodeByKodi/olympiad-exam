...
const QUESTION_TEMPLATES = {
  ...
  'countries': [
    ...
    { q: 'What is the capital of France?', opts: ['London', 'Berlin', 'Paris', 'Rome'], c: 2, e: 'Paris is the capital of France.' },
    { q: 'What is the capital of the USA?', opts: ['New York', 'Los Angeles', 'Washington D.C.', 'Chicago'], c: 2, e: 'Washington D.C. is the capital.' },
    { q: 'What is the capital of China?', opts: ['Shanghai', 'Beijing', 'Hong Kong', 'Tokyo'], c: 1, e: 'Beijing is the capital of China.' },
    { q: 'What is the capital of the UK?', opts: ['Manchester', 'London', 'Birmingham', 'Edinburgh'], c: 1, e: 'London is the capital.' },
    { q: 'What is the capital of Australia?', opts: ['Sydney', 'Melbourne', 'Canberra', 'Brisbane'], c: 2, e: 'Canberra is the capital.' },
    { q: 'What is the capital of Germany?', opts: ['Munich', 'Berlin', 'Frankfurt', 'Hamburg'], c: 1, e: 'Berlin is the capital.' },
    { q: 'What is the capital of Russia?', opts: ['St Petersburg', 'Moscow', 'Kiev', 'Warsaw'], c: 1, e: 'Moscow is the capital.' },
    { q: 'What is the capital of Brazil?', opts: ['Rio', 'São Paulo', 'Brasília', 'Buenos Aires'], c: 2, e: 'Brasília is the capital.' },
    { q: 'What is the capital of Egypt?', opts: ['Alexandria', 'Cairo', 'Luxor', 'Giza'], c: 1, e: 'Cairo is the capital.' },
    { q: 'What is the capital of Canada?', opts: ['Toronto', 'Ottawa', 'Vancouver', 'Montreal'], c: 1, e: 'Ottawa is the capital.' },
    { q: 'What is the capital of Italy?', opts: ['Milan', 'Rome', 'Venice', 'Florence'], c: 1, e: 'Rome is the capital.' },
    { q: 'What is the capital of Spain?', opts: ['Barcelona', 'Madrid', 'Seville', 'Valencia'], c: 1, e: 'Madrid is the capital.' },
    { q: 'What is the capital of Pakistan?', opts: ['Lahore', 'Karachi', 'Islamabad', 'Rawalpindi'], c: 2, e: 'Islamabad is the capital.' },
    { q: 'What is the capital of Bangladesh?', opts: ['Chittagong', 'Dhaka', 'Khulna', 'Sylhet'], c: 1, e: 'Dhaka is the capital.' },
    { q: 'What is the capital of South Korea?', opts: ['Busan', 'Seoul', 'Incheon', 'Daegu'], c: 1, e: 'Seoul is the capital.' },
    { q: 'What is the capital of Indonesia?', opts: ['Surabaya', 'Jakarta', 'Bali', 'Bandung'], c: 1, e: 'Jakarta is the capital.' },
    { q: 'What is the capital of South Africa?', opts: ['Cape Town', 'Johannesburg', 'Pretoria', 'Durban'], c: 2, e: 'Pretoria is the capital.' },
    { q: 'What is the capital of Mexico?', opts: ['Guadalajara', 'Mexico City', 'Cancun', 'Monterrey'], c: 1, e: 'Mexico City is the capital.' },
    { q: 'What is the capital of Turkey?', opts: ['Istanbul', 'Ankara', 'Izmir', 'Antalya'], c: 1, e: 'Ankara is the capital.' },
    { q: 'What is the capital of Saudi Arabia?', opts: ['Jeddah', 'Riyadh', 'Mecca', 'Medina'], c: 1, e: 'Riyadh is the capital.' },
    { q: 'What is the capital of Thailand?', opts: ['Phuket', 'Bangkok', 'Chiang Mai', 'Pattaya'], c: 1, e: 'Bangkok is the capital.' },
    { q: 'What is the capital of Argentina?', opts: ['Buenos Aires', 'Córdoba', 'Rosario', 'Mendoza'], c: 0, e: 'Buenos Aires is the capital.' },
    { q: 'What is the capital of Greece?', opts: ['Thessaloniki', 'Athens', 'Sparta', 'Crete'], c: 1, e: 'Athens is the capital.' },
  ],
  'monuments': [
    { q: 'Where is the Taj Mahal located?', opts: ['Agra', 'Delhi', 'Jaipur', 'Mumbai'], c: 0, e: 'Taj Mahal is in Agra.' },
    { q: 'Which monument is one of the Seven Wonders?', opts: ['Red Fort', 'Taj Mahal', 'Qutub Minar', 'India Gate'], c: 1, e: 'Taj Mahal is a Wonder.' },
    { q: 'Where are the Pyramids?', opts: ['India', 'Egypt', 'Greece', 'Italy'], c: 1, e: 'Pyramids are in Egypt.' },
    { q: 'Which country has the Great Wall?', opts: ['India', 'China', 'Japan', 'Korea'], c: 1, e: 'Great Wall is in China.' },
    { q: 'Where is the Eiffel Tower?', opts: ['London', 'Berlin', 'Paris', 'Rome'], c: 2, e: 'Eiffel Tower is in Paris.' },
    { q: 'Which monument is in Delhi?', opts: ['Taj Mahal', 'India Gate', 'Charminar', 'Gateway of India'], c: 1, e: 'India Gate is in Delhi.' },
    { q: 'Where is the Statue of Liberty?', opts: ['Washington', 'London', 'New York', 'Boston'], c: 2, e: 'Statue of Liberty is in New York.' },
    { q: 'Which monument is in Hyderabad?', opts: ['Taj Mahal', 'Charminar', 'Qutub Minar', 'India Gate'], c: 1, e: 'Charminar is in Hyderabad.' },
    { q: 'Where is the Colosseum?', opts: ['Greece', 'Rome', 'Spain', 'Egypt'], c: 1, e: 'Colosseum is in Rome.' },
    { q: 'Which monument is in Mumbai?', opts: ['India Gate', 'Gateway of India', 'Charminar', 'Red Fort'], c: 1, e: 'Gateway of India is in Mumbai.' },
    { q: 'Where is the Leaning Tower of Pisa?', opts: ['Rome', 'Florence', 'Pisa', 'Venice'], c: 2, e: 'Leaning Tower is in Pisa.' },
    { q: 'Which monument was built by Shah Jahan?', opts: ['Red Fort', 'Taj Mahal', 'Qutub Minar', 'India Gate'], c: 1, e: 'Shah Jahan built Taj Mahal.' },
    { q: 'Where is the Red Fort?', opts: ['Agra', 'Delhi', 'Jaipur', 'Mumbai'], c: 1, e: 'Red Fort is in Delhi.' },
    { q: 'Which monument is a symbol of love?', opts: ['Eiffel Tower', 'Taj Mahal', 'Colosseum', 'Pyramids'], c: 1, e: 'Taj Mahal is a symbol of love.' },
    { q: 'Where is the Big Ben?', opts: ['Paris', 'London', 'Berlin', 'Rome'], c: 1, e: 'Big Ben is in London.' },
    { q: 'Which monument is in Jaipur?', opts: ['Taj Mahal', 'Hawa Mahal', 'Charminar', 'Gateway of India'], c: 1, e: 'Hawa Mahal is in Jaipur.' },
    { q: 'Where is the Christ the Redeemer statue?', opts: ['Argentina', 'Brazil', 'Chile', 'Peru'], c: 1, e: 'Christ the Redeemer is in Rio, Brazil.' },
    { q: 'Which monument is the tallest brick minaret?', opts: ['Taj Mahal', 'Qutub Minar', 'Charminar', 'India Gate'], c: 1, e: 'Qutub Minar is the tallest.' },
    { q: 'Where is the Parthenon?', opts: ['Rome', 'Athens', 'Egypt', 'Turkey'], c: 1, e: 'Parthenon is in Athens.' },
    { q: 'Which monument is in Agra?', opts: ['Red Fort', 'Taj Mahal', 'Qutub Minar', 'India Gate'], c: 1, e: 'Taj Mahal is in Agra.' },
    { q: 'Where is the Sydney Opera House?', opts: ['Melbourne', 'Sydney', 'Canberra', 'Brisbane'], c: 1, e: 'Opera House is in Sydney.' },
    { q: 'Which monument is a memorial to soldiers?', opts: ['Taj Mahal', 'India Gate', 'Charminar', 'Gateway of India'], c: 1, e: 'India Gate honours soldiers.' },
    { q: 'Where is the Golden Temple?', opts: ['Delhi', 'Amritsar', 'Jaipur', 'Mumbai'], c: 1, e: 'Golden Temple is in Amritsar.' },
    { q: 'Which monument is made of white marble?', opts: ['Red Fort', 'Taj Mahal', 'Qutub Minar', 'Charminar'], c: 1, e: 'Taj Mahal is white marble.' },
    { q: 'Where is the Lotus Temple?', opts: ['Mumbai', 'Kolkata', 'Delhi', 'Chennai'], c: 2, e: 'Lotus Temple is in Delhi.' },
    { q: 'Which monument is a UNESCO World Heritage Site?', opts: ['India Gate', 'Taj Mahal', 'Gateway of India', 'Charminar'], c: 1, e: 'Taj Mahal is a Heritage Site.' },
  ],
  ...
  'personalities': [
    { q: 'Who is known as the Father of the Nation in India?', opts: ['Nehru', 'Gandhi', 'Tagore', 'Patel'], c: 1, e: 'Mahatma Gandhi is the Father of the Nation.' },
    { q: 'Who wrote the Indian national anthem?', opts: ['Gandhi', 'Tagore', 'Nehru', 'Patel'], c: 1, e: 'Rabindranath Tagore wrote Jana Gana Mana.' },
    { q: 'Who was the first Prime Minister of India?', opts: ['Gandhi', 'Nehru', 'Patel', 'Bose'], c: 1, e: 'Jawaharlal Nehru was the first PM.' },
    { q: 'Who discovered gravity?', opts: ['Einstein', 'Newton', 'Galileo', 'Copernicus'], c: 1, e: 'Isaac Newton discovered gravity.' },
    { q: 'Who invented the light bulb?', opts: ['Tesla', 'Edison', 'Faraday', 'Bell'], c: 1, e: 'Thomas Edison invented the light bulb.' },
    { q: 'Who is known as the Missile Man of India?', opts: ['Nehru', 'Kalam', 'Bose', 'Patel'], c: 1, e: 'APJ Abdul Kalam was the Missile Man.' },
    { q: 'Who founded the Red Cross?', opts: ['Florence Nightingale', 'Henri Dunant', 'Clara Barton', 'Mother Teresa'], c: 1, e: 'Henri Dunant founded the Red Cross.' },
    { q: 'Who painted the Mona Lisa?', opts: ['Picasso', 'Van Gogh', 'Leonardo da Vinci', 'Rembrandt'], c: 2, e: 'Leonardo da Vinci painted the Mona Lisa.' },
    { q: 'Who wrote Romeo and Juliet?', opts: ['Dickens', 'Shakespeare', 'Austen', 'Twain'], c: 1, e: 'William Shakespeare wrote Romeo and Juliet.' },
    { q: 'Who was the first woman Prime Minister of India?', opts: ['Sonia Gandhi', 'Indira Gandhi', 'Pratibha Patil', 'Sarojini Naidu'], c: 1, e: 'Indira Gandhi was the first woman PM.' },
    { q: 'Who invented the telephone?', opts: ['Edison', 'Tesla', 'Bell', 'Marconi'], c: 2, e: 'Alexander Graham Bell invented the telephone.' },
    { q: 'Who discovered America?', opts: ['Magellan', 'Columbus', 'Vasco da Gama', 'Marco Polo'], c: 1, e: 'Christopher Columbus reached America.' },
    { q: 'Who founded Microsoft?', opts: ['Jobs', 'Gates', 'Zuckerberg', 'Bezos'], c: 1, e: 'Bill Gates co-founded Microsoft.' },
    { q: 'Who was known as the Nightingale of India?', opts: ['Indira Gandhi', 'Sarojini Naidu', 'Mother Teresa', 'Rani Lakshmibai'], c: 1, e: 'Sarojini Naidu was the Nightingale of India.' },
    { q: 'Who developed the theory of relativity?', opts: ['Newton', 'Einstein', 'Hawking', 'Bohr'], c: 1, e: 'Albert Einstein developed the theory of relativity.' },
    { q: 'Who founded the Mughal Empire in India?', opts: ['Akbar', 'Babur', 'Shah Jahan', 'Aurangzeb'], c: 1, e: 'Babur founded the Mughal Empire.' },
    { q: 'Who invented the printing press?', opts: ['Edison', 'Gutenberg', 'Bell', 'Marconi'], c: 1, e: 'Johannes Gutenberg invented the printing press.' },
    { q: 'Who was the first President of India?', opts: ['Nehru', 'Prasad', 'Radhakrishnan', 'Patel'], c: 1, e: 'Rajendra Prasad was the first President.' },
    { q: 'Who discovered penicillin?', opts: ['Pasteur', 'Fleming', 'Koch', 'Lister'], c: 1, e: 'Alexander Fleming discovered penicillin.' },
    { q: 'Who founded Facebook?', opts: ['Jobs', 'Gates', 'Zuckerberg', 'Bezos'], c: 2, e: 'Mark Zuckerberg founded Facebook.' },
    { q: 'Who was the Iron Man of India?', opts: ['Nehru', 'Patel', 'Bose', 'Gandhi'], c: 1, e: 'Sardar Vallabhbhai Patel was the Iron Man.' },
    { q: 'Who wrote the Ramayana?', opts: ['Vyasa', 'Valmiki', 'Tulsidas', 'Kalidasa'], c: 1, e: 'Valmiki wrote the Ramayana.' },
    { q: 'Who invented the aeroplane?', opts: ['Edison', 'Wright brothers', 'Bell', 'Tesla'], c: 1, e: 'The Wright brothers invented the aeroplane.' },
    { q: 'Who was Mother Teresa?', opts: ['Scientist', 'Nun and humanitarian', 'Politician', 'Writer'], c: 1, e: 'Mother Teresa was a nun and humanitarian.' },
    { q: 'Who founded Apple Inc.?', opts: ['Gates', 'Jobs', 'Zuckerberg', 'Bezos'], c: 1, e: 'Steve Jobs co-founded Apple.' },
    { q: 'Who discovered India by sea route?', opts: ['Columbus', 'Magellan', 'Vasco da Gama', 'Marco Polo'], c: 2, e: 'Vasco da Gama reached India by sea.' },
  ],
  'important-days': [
    { q: 'When is Republic Day celebrated in India?', opts: ['15 August', '26 January', '2 October', '25 December'], c: 1, e: '26 January is Republic Day.' },
    { q: 'When is Independence Day celebrated?', opts: ['26 January', '15 August', '2 October', '14 November'], c: 1, e: '15 August is Independence Day.' },
    { q: 'When is Gandhi Jayanti celebrated?', opts: ['15 August', '26 January', '2 October', '25 December'], c: 2, e: '2 October is Gandhi Jayanti.' },
    { q: 'When is World Environment Day?', opts: ['22 April', '5 June', '15 September', '10 December'], c: 1, e: '5 June is World Environment Day.' },
    { q: 'When is Teachers Day celebrated in India?', opts: ['15 August', '5 September', '2 October', '14 November'], c: 1, e: '5 September is Teachers Day.' },
    { q: 'When is Children\'s Day celebrated in India?', opts: ['5 September', '14 November', '25 December', '1 January'], c: 1, e: '14 November is Children\'s Day.' },
    { q: 'When is World Health Day?', opts: ['1 March', '7 April', '12 May', '20 June'], c: 1, e: '7 April is World Health Day.' },
    { q: 'When is International Women\'s Day?', opts: ['1 January', '8 March', '15 May', '10 October'], c: 1, e: '8 March is International Women\'s Day.' },
    { q: 'When is Earth Day celebrated?', opts: ['5 June', '22 April', '15 September', '10 December'], c: 1, e: '22 April is Earth Day.' },
    { q: 'When is Human Rights Day?', opts: ['1 January', '10 December', '15 August', '25 December'], c: 1, e: '10 December is Human Rights Day.' },
    { q: 'When is World Water Day?', opts: ['5 June', '22 March', '15 September', '10 October'], c: 1, e: '22 March is World Water Day.' },
    { q: 'When is International Literacy Day?', opts: ['5 September', '8 September', '2 October', '14 November'], c: 1, e: '8 September is International Literacy Day.' },
    { q: 'When is World Food Day?', opts: ['5 June', '16 October', '15 September', '10 December'], c: 1, e: '16 October is World Food Day.' },
    { q: 'When is National Science Day in India?', opts: ['5 September', '28 February', '2 October', '14 November'], c: 1, e: '28 February is National Science Day.' },
    { q: 'When is World Wildlife Day?', opts: ['5 June', '3 March', '22 April', '10 December'], c: 1, e: '3 March is World Wildlife Day.' },
    { q: 'When is International Day of Peace?', opts: ['15 August', '21 September', '2 October', '10 December'], c: 1, e: '21 September is International Day of Peace.' },
    { q: 'When is World Tourism Day?', opts: ['5 June', '27 September', '22 April', '10 October'], c: 1, e: '27 September is World Tourism Day.' },
    { q: 'When is World Animal Welfare Day?', opts: ['5 June', '4 October', '22 April', '10 December'], c: 1, e: '4 October is World Animal Welfare Day.' },
    { q: 'When is Constitution Day in India?', opts: ['26 January', '15 August', '26 November', '2 October'], c: 2, e: '26 November is Constitution Day.' },
    { q: 'When is World Diabetes Day?', opts: ['7 April', '14 November', '10 December', '1 January'], c: 1, e: '14 November is World Diabetes Day.' },
    { q: 'When is International Day of Yoga?', opts: ['5 September', '21 June', '2 October', '14 November'], c: 1, e: '21 June is International Day of Yoga.' },
    { q: 'When is World Ozone Day?', opts: ['5 June', '16 September', '22 April', '10 December'], c: 1, e: '16 September is World Ozone Day.' },
    { q: 'When is World AIDS Day?', opts: ['7 April', '1 December', '10 October', '25 December'], c: 1, e: '1 December is World AIDS Day.' },
    { q: 'When is National Sports Day in India?', opts: ['15 August', '29 August', '2 October', '14 November'], c: 1, e: '29 August is National Sports Day.' },
    { q: 'When is World Heritage Day?', opts: ['5 June', '18 April', '22 April', '10 December'], c: 1, e: '18 April is World Heritage Day.' },
    { q: 'When is International Day of Democracy?', opts: ['26 January', '15 September', '10 December', '1 January'], c: 1, e: '15 September is International Day of Democracy.' },
  ],
  'symbols': [
    { q: 'What does the white colour in the Indian flag represent?', opts: ['Courage', 'Peace and truth', 'Growth', 'Sacrifice'], c: 1, e: 'White represents peace and truth.' },
    { q: 'What do the five Olympic rings represent?', opts: ['Five sports', 'Five continents', 'Five colours', 'Five countries'], c: 1, e: 'The rings represent five continents.' },
    { q: 'What is the national emblem of India?', opts: ['Lotus', 'Ashoka Chakra', 'Lion Capital', 'Peacock'], c: 2, e: 'The Lion Capital is the national emblem.' },
    { q: 'What does the red cross symbol mean?', opts: ['Hospital', 'Medical aid', 'Danger', 'Stop'], c: 1, e: 'Red cross indicates medical aid.' },
    { q: 'What does a dove often symbolise?', opts: ['War', 'Peace', 'Strength', 'Speed'], c: 1, e: 'A dove symbolises peace.' },
    { q: 'What does the symbol @ mean in email?', opts: ['And', 'At', 'About', 'Around'], c: 1, e: '@ means "at" in email addresses.' },
    { q: 'What does the recycling symbol show?', opts: ['Three arrows in a loop', 'A tree', 'A bin', 'Water'], c: 0, e: 'Three arrows in a loop indicate recycling.' },
    { q: 'What does the heart symbol usually mean?', opts: ['Health', 'Love', 'Courage', 'Strength'], c: 1, e: 'Heart symbolises love.' },
    { q: 'What does the skull and crossbones warn about?', opts: ['Medicine', 'Poison or danger', 'Pirates only', 'History'], c: 1, e: 'Skull and crossbones warn of poison.' },
    { q: 'What does the green light in a traffic signal mean?', opts: ['Stop', 'Go', 'Slow down', 'Wait'], c: 1, e: 'Green means go.' },
    { q: 'What does the saffron in the Indian flag represent?', opts: ['Peace', 'Courage and sacrifice', 'Growth', 'Prosperity'], c: 1, e: 'Saffron represents courage and sacrifice.' },
    { q: 'What does the green in the Indian flag represent?', opts: ['Courage', 'Peace', 'Growth and fertility', 'Truth'], c: 2, e: 'Green represents growth and fertility.' },
    { q: 'What does the Ashoka Chakra have?', opts: ['8 spokes', '12 spokes', '24 spokes', '32 spokes'], c: 2, e: 'Ashoka Chakra has 24 spokes.' },
    { q: 'What does a white flag often mean?', opts: ['Victory', 'Surrender or truce', 'Peace only', 'War'], c: 1, e: 'White flag can mean surrender or truce.' },
    { q: 'What does the symbol % mean?', opts: ['Division', 'Percent', 'Multiply', 'Addition'], c: 1, e: '% means percent.' },
    { q: 'What does the symbol + mean?', opts: ['Minus', 'Plus or add', 'Multiply', 'Divide'], c: 1, e: '+ means plus or add.' },
    { q: 'What does the symbol = mean?', opts: ['Approximately', 'Equals', 'Greater than', 'Less than'], c: 1, e: '= means equals.' },
    { q: 'What does a red octagon usually mean?', opts: ['Go', 'Stop', 'Slow', 'Caution'], c: 1, e: 'Red octagon means stop.' },
    { q: 'What does the infinity symbol look like?', opts: ['A circle', 'A figure 8 on its side', 'A spiral', 'A star'], c: 1, e: 'Infinity is a sideways figure 8.' },
    { q: 'What does the symbol $ represent?', opts: ['Euro', 'Dollar', 'Pound', 'Rupee'], c: 1, e: '$ represents dollar.' },
    { q: 'What does the symbol € represent?', opts: ['Dollar', 'Pound', 'Euro', 'Yen'], c: 2, e: '€ represents euro.' },
    { q: 'What does the symbol ₹ represent?', opts: ['Dollar', 'Pound', 'Euro', 'Indian Rupee'], c: 3, e: '₹ represents Indian Rupee.' },
    { q: 'What does a thumbs up usually mean?', opts: ['No', 'Yes or good', 'Maybe', 'Stop'], c: 1, e: 'Thumbs up means yes or good.' },
    { q: 'What does the peace symbol represent?', opts: ['War', 'Peace', 'Victory', 'Strength'], c: 1, e: 'The peace symbol represents peace.' },
    { q: 'What does the symbol # mean in social media?', opts: ['At', 'Hashtag', 'Number only', 'Dollar'], c: 1, e: '# is used as hashtag in social media.' },
    { q: 'What does a green tick often mean?', opts: ['Wrong', 'Correct or done', 'Pending', 'Warning'], c: 1, e: 'Green tick means correct or done.' },
  ],
  'current-affairs': [
...
function getTemplatesForTopic(topicName, _grade) {
  ...
  const templates = QUESTION_TEMPLATES[key] || QUESTION_TEMPLATES['current-affairs'];
  return templates;
}
